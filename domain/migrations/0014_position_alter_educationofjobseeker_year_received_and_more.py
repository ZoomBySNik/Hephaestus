# Generated by Django 4.2.7 on 2024-01-02 08:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('domain', '0013_alter_application_date_of_application'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='position',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='domain.position', verbose_name='Должность'),
        ),
        migrations.AlterField(
            model_name='resume',
            name='position',
