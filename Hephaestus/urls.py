...
urlpatterns = [
    ...
    path('jobseeker/<str:job_seeker_id>/software_and_hardware_tools', software_and_hardware_tools_view,
    ...
    path('jobseeker/<str:job_seeker_id>/work_experience', job_seeker_work_experience_view,
